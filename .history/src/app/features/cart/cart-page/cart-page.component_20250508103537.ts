...
@Component({
    ...
    <div class="container">
      ...
      <div class="cart-content" *ngIf="cartItems.length > 0">
        <div class="cart-table-section">
          <p-card>
            <p-table [value]="cartItems" [tableStyle]="{ 'min-width': '50rem' }" dataKey="part.id" styleClass="cart-table">
                ...
                <tr>
                  <td>
                    <div class="item-details">
                      <img [src]="item.part.imageUrl" [alt]="item.part.name" class="item-thumbnail" (click)="viewItemDetails(item.part.id)">
          ...
          <p-card header="Order Summary" styleClass="order-summary-card">
            <div class="summary-content">
              ...
              <div class="summary-info">
                <p><i class="pi pi-info-circle"></i> This is a demo application. No actual payments will be processed.</p>
              </div>
            </div>
          </p-card>
        </div>
    ...
    >
      <div class="dialog-content">
        ...
        <div class="dialog-message">
          ...
          <p>In a real-world application, this would proceed to a secure checkout process where you could enter shipping details and payment information.</p>
  ...
  styles: [`
    ...
    .item-part-number, .item-provider {
      font-size: 0.85rem;
